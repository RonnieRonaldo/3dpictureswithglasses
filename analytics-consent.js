(() => {
  'use strict';
  const ID = 'G-F61B74DVS8', KEY = 'gallery-analytics-choice-v1';
  ...
  function clearCookies() {
    const domains = ['', location.hostname, '.' + location.hostname, '.3dpictureswithglasses.com'];
    const paths = ['/'];
